...
````
make -C tools/depends/target/cmakebuildsys Gen=Xcode CMAKE_EXTRA_ARGUMENTS="-DPLATFORM_BUNDLE_IDENTIFIER=\"tv.kodi.kodi\" -DCODE_SIGN_IDENTITY=\"iPhone Developer: *** (**********)\" -DPROVISIONING_PROFILE_APP=\"tv.kodi.kodi\" -DPROVISIONING_PROFILE_TOPSHELF=\"tv.kodi.kodi.Topshelf\""
````
